                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="cartarea__product__thumbnail">
                                                    <a href="#">
                                                        <img src="{{ Storage::url($item->product->image) }}" alt="{{ $item->product->name }}" width="80">
                                                    </a>
                                                </td>
                                                <td class="cartarea__product__name"><a href="#">{{ $item->product->name}}</a></td>
                                                <td class="cartarea__product__price__cart"><span class="amount">Rp {{ number_format($item->product->price, 0, ",", ".")}}</span></td>
                                                    ...
                                                    <form action="{{ route('cart.update', $item->id) }}" method="POST">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" name="qty" value="{{ $item->qty }}"
                                                                class="form-control" min="1" max="{{ $item->product->stock }}"
